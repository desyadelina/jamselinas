    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-8 lg:gap-6">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center gap-6">
                <!-- left column: images 1 sama 3 stacked -->
                ...
                <!-- right positioned: image 2 with offset -->
                <div class="lg:mt-12">
            ...
            <div class="flex flex-col gap-6 font-inter">
                <p class="text-lg lg:text-[30px] text-justify leading-relaxed">
                    ...
                    telah tumbuh menjadi wadah komunitas sepeda lipat terbesar di Indonesia dan sudah berusia 17 tahun
                    untuk
                    keberadaannya.
                </p>
                <p class="text-lg lg:text-[30px] text-justify leading-relaxed lg:ml-16">
                    ...
                    Indonesia
                    Nomor: JID2024102926 tentang JAMSELINAS (Jambore Sepeda Lipat Nasional) - IDFB. Jamselinas telah
                ...
                <p class="text-lg lg:text-[30px] text-justify leading-relaxed lg:ml-16">
                    ...
                    bersiap sebagai tuan rumah dengan infrastruktur yang memadai dan akses transportasi yang mudah.
                </p>
            </div>
        </div>
    </div>
