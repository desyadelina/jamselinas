<section
    class="relative w-full min-h-[600px] lg:h-[968px] bg-gradient-to-b from-jamselinas-gradient-start to-jamselinas-gradient-mid flex items-center">
    <img src="{{ asset('images/hero_bg.png') }}" alt=""
        class="absolute left-0 top-[100px] z-0 pointer-events-none select-none w-[842px] max-w-none" />
    <div class="container mx-auto flex flex-col lg:flex-row items-center py-16 gap-8 relative z-10">
        <div class="flex-1 flex flex-col gap-6 text-center lg:text-left">
            <h1 class="font-bold text-3xl lg:text-5xl text-jamselinas-secondary leading-tight">Nikmati Sensasi bersepeda
